...
def start():
    ...
    x_bob = randint(0, p // 2)
    q1_bob, q2_bob = get_multiply_point(x1, y1, a, p, x_bob)

    s_alice = get_multiply_point(q1_bob, q2_bob, a, p, x_alice)
    s_bob = get_multiply_point(q1_alice, q2_alice, a, p, x_bob)
